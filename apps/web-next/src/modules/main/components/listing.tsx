        ...
        <div className="pt-16 max-w-xl mx-auto">
          ...
          <div className="pt-4">
            ...
            <p className="text-sm text-gray-800 text-center">
              This error could caused by NHentai API itself and it usually take
              a few hours to be fixed. In meanwhile, you can explore other
              galleries in "Listing" section
            </p>
          </div>
        </div>
      ) : isLoading ? (
