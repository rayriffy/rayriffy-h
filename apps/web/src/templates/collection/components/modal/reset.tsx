  ...
  return (
    <React.Fragment>
      ...
      <div className='pt-4 pb-2 flex justify-end flex-wrap'>
        ...
        <button
          className={`${!lock ? 'bg-red-500 hover:bg-red-700 cursor-pointer text-white' : 'bg-gray-500 hover:bg-gray-700 cursor-not-allowed text-white dark:text-gray-800'} font-bold py-2 px-4 rounded transition-all duration-200 select-none`}
