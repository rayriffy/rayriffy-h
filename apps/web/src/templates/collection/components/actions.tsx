      ...
      <div className="px-0 md:px-6 relative">
        {menuOpen && activeModal === 'none' ? (
          <div className="absolute mt-4 bg-white dark:bg-gray-800 rounded overflow-hidden w-2/5 max-w-xs text-gray-900 dark:text-white py-2 z-40">
            <div
              className="cursor-pointer px-6 py-2 hover:bg-gray-300 dark:hover:bg-gray-700"
            ...
            <div
              className="cursor-pointer px-6 py-2 hover:bg-gray-300 dark:hover:bg-gray-700 border-t border-gray-300 dark:border-gray-700"
