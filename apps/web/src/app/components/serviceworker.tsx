    ...
    <React.Fragment>
      <div className='text-center'>
        ...
        <div id='sw-update-green' className='p-2 bg-green-800 items-center text-green-100 leading-none rounded-full mb-4 hidden' role='alert'>
          ...
          <span id='sw-update-complete' className='font-semibold mr-2 text-left flex-auto hidden'>Update complete! Reload required.</span>
          <span id='sw-update-installed' className='font-semibold mr-2 text-left flex-auto hidden'>Ready to work offline!</span>
        </div>
      </div>
    </React.Fragment>
  )
