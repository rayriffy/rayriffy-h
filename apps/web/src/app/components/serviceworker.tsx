  ...
  return (
    <React.Fragment>
      <div className="text-center">
        <div id="sw-update-found" className="p-2 bg-blue-800 items-center text-blue-100 leading-none rounded-full hidden" role="alert">
        ...
        <div id="sw-update-green" className="p-2 bg-green-800 items-center text-green-100 leading-none rounded-full hidden" role="alert">
