...
export type { NhentaiGallery } from './@types/nhentai/NhentaiGallery'
export type { NhentaiImage } from './@types/nhentai/NhentaiImage'
export type { NhentaiTag } from './@types/nhentai/NhentaiTag'
